...
function Navbar({ onToggleSidebar }) {
  ...
  const [dark, setDark] = useState(() => {
    ...
    // Default fallback if no saved preference, e.g., OS preference
  ...
  // Mobile menu handler (calls a prop, context, or custom function to open the sidebar)
  ...
  return (
    <>
      <header className="py-4 bg-white shadow-md dark:bg-gray-800">
